...
if __name__ == "__main__":
    ...
    print(convert3Pto2P("Tell Dom she's being all loud and shit and we're in class"))
    print(convert3Pto2P("Tell Tam to tell Sim that she is being a jerk"))
    print(convert3Pto2P("Tell Tam to shower because he smells"))
    print(convert3Pto2P("Tell Dom to stop herself from thinking ficticious characters are her family"))
