...
class DanBot:
    ...
    def callback_topluck(self, msg, chat_id):
        ...
        reply = (
            "Luck ranking:\n\n" + "```\n" + "\n".join(f"{user[:11] + ':':<12} {luck:<+9.2%} (z={z:+.2f})" for user, (luck, z) in top) + "\n```"
        )
    ...
    def callback_topz(self, msg, chat_id):
        ...
        reply = (
            "Z-score ranking:\n\n" + "```\n" + "\n".join(f"{user[:11] + ':':<12} {z:<+7.2f} (dev={luck:+.2%})" for user, (z, luck) in top) + "\n```"
        )
